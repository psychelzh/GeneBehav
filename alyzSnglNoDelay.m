function [FNLearn, FNRecog, WM3, stopsignal, shiftnumber, stroop, ...
    ...
    KLearn,  KRecog,  shiftcolor,  filter,  WM2,  SPST, SRT, CRT] ...
    = alyzSnglNoDelay(subject_code, datapath)
...
%% FNLearn
dataname = dir([datapath, sprintf('\\%sSub%03d_*', 'FNLearn_', subject_code)]); %编号已经改变，此处理应修正（'%03d'可以直接使用'%d’）。
