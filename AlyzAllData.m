function AlyzAllData(datapath, sublist)
%ALYZALLDATA a conversion from the function AnalysizAllData.m
...
fid = fopen('raw_add.log', 'w'); %Discarding existing contents for they are just obsolete for this analysis.
fprintf(fid, '========================================================\n%s Checking...\n', date);

if nargin == 1
    %Find all subjects' id.
    sublist = check_sublist(datapath);
end
...
try % In case error occurs and file is not closed.
    for subidx = 1 : length(sublist)
        ...
        [FNLearn, FNRecog, WM3, stopsignal, shiftnumber, stroop, ...
            ...
            KLearn, KRecog, shiftcolor, filter, WM2, SPST, Delay, SRT, CRT] = alyzSngl(subject_code, datapath);
        alldata(subidx, :) = [...
            subject_code ...
            FNLearn(2:4)...
            FNRecog(2:8)...
...
res = array2table(alldata, 'VariableNames', matlab.lang.makeValidName(alldataname));
writetable(res, fullfile(outdatapath, sprintf('GenData_%s.csv', datestr(now, 'mm-dd-HH-MM'))))
